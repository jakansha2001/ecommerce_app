...
final goRouterProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    // By default, the redirect function is only called when we navigate to a new route.
    ...
    // But if we want to navigate in response to an application state change, we need to use a refreshListenable.
          ...
          routes: [
            GoRoute(
              ...
              builder: (context, state) {
                final productId =
                    state.params['id']!; //* string literal should match with product_grid.dart file
