...
// *Using ConsumerWidget  (everything in the build method will rebuild if the provider value changes -> performance issue)
...
//   }
// }
// *Using Consumer  (Only code inside the builder will rebuild)
